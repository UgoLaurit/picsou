...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-white transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zinc-950 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "flex flex-row gap-1.5 bg-frost-400 text-snow-storm-100 hover:bg-frost-400/80",
        secondary:
          "flex flex-row gap-1.5 bg-snow-storm-100 text-polar-night-300 hover:bg-snow-storm-100/90",
        destructive:
          "flex flex-row gap-1.5 bg-aurora-100 text-polar-night-100 hover:bg-aurora-100/90",
      },
      size: {
